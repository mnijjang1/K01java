...
/*
블력주석 지정하는 법 - 블럭 시작점 끝점 명확하게 잡고 컨트롤 + 쉬프트 + /
블력주석 해제하는 법 - 블럭 시작점 끝점 명확하게 잡고 컨트롤 + 쉬프트 + \(토글 안됨)
*/
...
/* 
 public 클래스는 해당 java파일을 대표하는 클래스로 파일명과 동일하고 다른 패키지에서도 접근이 가능하다.
 단, 하나의 자바파일에 하나만 정의할 수 있다. 
*/ 
public class E01AccessModifier1 {
	...
	/*
	 private으로 선언된 멤버(변수 혹은 메소드)를 외부 클래스에서 접근하고 싶을 때는

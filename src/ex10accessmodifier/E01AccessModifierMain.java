...
public class E01AccessModifierMain {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 해당 멈버는 동일 클래스 내에서만 접근을 허용한다.
		 
		 ※private으로 선언된 멤버를 외부클래스에서 접근할 때에는
		...
		// 동일한 패키지에 선언된 클래스이므로 import선언 없이 객체 생성 및 접근이 가능하다
		...
		//System.out.println("two.defaultVar = " + two.defaultVal); // 에러발생

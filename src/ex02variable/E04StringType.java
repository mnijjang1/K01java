...
public class E04StringType {
	...
	public static void main(String[] args) {
		...
		/*
		 문자열 + 정수 => 문자열
		 즉, 문자열 뒤에 정수가 연결된 형태로 출력
		 */
		String strNumber ="100";
		System.out.println(strNumber + number); // 출력값: 10099
		
		/*
		 String은클래스이므로 new 키워드를 이용해서 인스턴스(객체)를 생성한 후 문자열을 참조한다
		 */
		...
		System.out.println("총점:"+kor+eng+math); //앞에서부터 순서대로 문자열+숫자로 인식하여 1009998로 출력

...
public class E01StringBasic {
	...
	public static void main(String[] args) {
		...
		/*
		 String클래스의 객체생성방법1
		  - new를 이용한다. 
		  - new를 사용하면 동일한 문자열이라도 항상 새로운 메모리를 할당하게 된다.
		 */
		String str1 = new String("Hello JAVA");
		String str2 = new String("Hello JAVA");
		
		/*
		 str1, str2는 String 객체의 참조값을 가지고 있으므로 아래는 단순한 참조값의 비교를 진행한다.
		 */
		if (str1==str2) {
		...
		// 내용에 대한 비교를 한다.(동일주소를 참조하므로 동일함)
		System.out.println("equals()메소드로 문자열 비교 : "+ str3.equals(str4));
		
		/*
		 자바에서 문자열 객체를 생성할 때 new를 사용하지 않고 ""를 사용하면
		 동일한 문자열인 경우 메모리를 하나만 사용하여 공유하게 된다. 47라인, 48라인과 같은 경우
		 */
		if (str3==str4) {

...
/*
 ...
 Predicate : 매개변수가 있고,  리턴은 boolean값
 Consumer : 매개변수가 있고,리턴값 없음
 Supplier : 매개변수가 없고, 리턴값 있음
 Function : 매개변수가 없고, 리턴값 있음
 */
public class Ex06Define1Predicate {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 를 간소화 하면 63라인의 a -> a.getGender().equals("남")가 된다.
		 
		 이와 같은 람다식을 간소화 방법에 있어서 아래와 같이 기술할 수 있다
	...
	public static double avg(Predicate<Human> ph, List<Human> li) {
		int pCount = 0; // 전달된 객체의 셩별을 판단하여 인원수를 카운트할 변수 선언
		int tCount = 0; // 점수를 더해서 총점을 저장하기 위한 변수 선언

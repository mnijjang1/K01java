...
public class Ex06Define2Supplier {
	...
	// 난수를 생성하여 반환하는 람다식을 매개변수로 받아 cnt개의 나수를 반환함
	...
	/*
	 Supplier<T>
	  ...
	  - 주로 실행후 호출한 곳으로 데이터를 생성한 후 반환한다.
	 */
	public static void main(String[] args) {
		 ...
		 */
		// 위의 get()메소드를 오버라이딩 하여 0~99사이의 난수를 반환하는 람다식 정의
		...
		int rNum = sup.get();
		// -> get()메소드가 반환하는 integer 객체를 Auto Unboxing해서 int형 변수에 저장한다.
		System.out.println("생성된 난수="+ rNum);
		
		// 10개의 난수를 생성해서  List 컬렉션으로 반환 받음

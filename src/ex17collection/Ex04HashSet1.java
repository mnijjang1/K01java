	...
	public static void main(String[] args) {
		...
		/*
		 5-1. 기본 클래스형 객체 중복 저장
		  - 기본 클래스의 경우에는 별도의 오버라이딩 처리없이 중복이 제거된다.
		...
		while (itr.hasNext()) {
			...
			else System.out.println("넌 뭐임?--;");
		}
		
		// 7. 존재여부 확인
		System.out.println(set.contains(strObject1) ? "strObject1 있다" : "strObject2없다");
		...
		// 9. 전체 삭제
		System.out.println("전체삭제 :"+ set.removeAll(set)); // set.clear();도 가능

...
/*
 ...
 다음에주어진조건으로 '사람'을 추상화하시오.
  ...
  - 행동의 조건
  	...
  	(사람은 무한히 먹을 수 없으며, 에너지가 마이너스가 되면 죽은 것과 같기 때문)
 */
public class Human {
	...
	//행동을 표현하는 멤머메소드 : 걷다, 생각하다, 먹다, 객체의 현재상태 표현
	void walk() {
		//에너지를 1 차감한 후 음수인지 확인하여 음수이면 0으로 고정.
		energy--;
		if (energy<0) {
			energy=0;
